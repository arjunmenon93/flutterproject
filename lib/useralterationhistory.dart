...
class modf extends StatefulWidget {
  final hello;
  modf({required this.hello});
  @override
  State<modf> createState() => _modfState();
}

class _modfState extends State<modf> {
      ...
      child: Scaffold(
        ...
        body: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              .where('officer', isEqualTo: widget.hello)
              .snapshots(),
